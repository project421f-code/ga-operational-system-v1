...
| **Frontend** | HTML + CSS + Vanilla JavaScript | Satu file `index.html` berisi semua UI |
| **Komunikasi** | `google.script.run` | Async RPC dari frontend ke backend |
| **Hosting** | Google Apps Script Web App | Deploy sebagai Web App |
